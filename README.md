# Create Branch Wizard REST OpenAPI Specification
[![Build Status](https://travis-ci.org/mibexsoftware/create-branch-wizard-rest-api.svg?branch=master)](https://travis-ci.org/mibexsoftware/create-branch-wizard-rest-api)
...
6. If you did everything correct, https://mibexsoftware.github.io/create-branch-wizard-rest-api/ will lead to your new docs
